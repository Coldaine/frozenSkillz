...
Reads `~/.Codex/usage-data/report.html` (generated by `/insights`) and extracts:
- **Action Items**: AGENTS.md improvements, unfinished tasks, follow-ups
...
Settings saved to `.Codex/skills/insight-extractor/config.json`.
...
- `~/.Codex/usage-data/report.html` (main report)
- `~/.Codex/usage-data/facets/` (structured JSON data)
...
3. **Priority Override**: Keep defaults / prioritize AGENTS.md items / prioritize automation / custom
...
- **~/.Codex/usage-data/report.html**: Source data
