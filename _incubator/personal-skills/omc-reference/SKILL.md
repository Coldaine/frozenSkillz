---
name: omc-reference
description: Configure and troubleshoot Oh My Codex (OMC), including its agents, workflow commands, team runtime, state tools, and commit settings. Use only when installing, configuring, updating, or diagnosing OMC itself; never for ordinary delegation, commits, Git, or unrelated skills.
---

# OMC Reference

Use this reference only for OMC installation, configuration, updates, or OMC-specific diagnosis. It does not authorize delegation and does not govern ordinary agent orchestration, commits, Git work, or unrelated skill use.
