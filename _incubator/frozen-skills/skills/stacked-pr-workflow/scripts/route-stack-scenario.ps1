...
$nextDocs = @(
  'docs/stacked-pr-workflow/scenario-router.md',
  'plugins/frozen-skills/skills/stacked-pr-workflow/workflows/greenfield-stack.md'
)
...
if ($openPrs.Count -gt 1 -and $nonTrunkBasePrs.Count -gt 0) {
  ...
  $nextDocs = @(
    'docs/stacked-pr-workflow/scenario-router.md',
    'plugins/frozen-skills/skills/stacked-pr-workflow/workflows/messy-pr-graph.md'
  )
}
...
elseif ($openPrs.Count -eq 1 -and $currentBranch -and $currentBranch -ne $trunk) {
  ...
  $nextDocs = @(
    'docs/stacked-pr-workflow/scenario-router.md',
    'plugins/frozen-skills/skills/stacked-pr-workflow/workflows/greenfield-stack.md',
    'plugins/frozen-skills/skills/stacked-pr-workflow/workflows/messy-branch-to-stack.md'
  )
}
