...
```powershell
powershell -File .\plugins\frozen-skills\skills\graphite-stacked-pr-workflow\scripts\graphite-preflight.ps1 -RepoRoot .
powershell -File .\plugins\frozen-skills\skills\graphite-stacked-pr-workflow\scripts\stack-inventory.ps1 -RepoRoot .
powershell -File .\plugins\frozen-skills\skills\graphite-stacked-pr-workflow\scripts\route-stack-scenario.ps1 -RepoRoot .
powershell -File .\plugins\frozen-skills\skills\graphite-stacked-pr-workflow\scripts\pr-base-audit.ps1 -RepoRoot .
powershell -File .\plugins\frozen-skills\skills\graphite-stacked-pr-workflow\scripts\infer-pr-dependencies.ps1 -RepoRoot .
```
...
- Skill workflow: [greenfield-stack.md](../../plugins/frozen-skills/skills/graphite-stacked-pr-workflow/workflows/greenfield-stack.md)
...
- Skill workflow: [messy-branch-to-stack.md](../../plugins/frozen-skills/skills/graphite-stacked-pr-workflow/workflows/messy-branch-to-stack.md)
...
- Skill workflow: [messy-pr-graph.md](../../plugins/frozen-skills/skills/graphite-stacked-pr-workflow/workflows/messy-pr-graph.md)
...
- Skill workflow: [stack-maintenance.md](../../plugins/frozen-skills/skills/graphite-stacked-pr-workflow/workflows/stack-maintenance.md)
...
```powershell
powershell -File .\plugins\frozen-skills\skills\graphite-stacked-pr-workflow\scripts\verify-parent-diffs.ps1 -RepoRoot . -Branches branch-a,branch-b,branch-c
```
