...
| `obra/superpowers` `v6.1.1` (`d884ae04edebef577e82ff7c4e143debd0bbec99`) | scout · forensic review in progress | `_incubator/scout/2026-07-23-obra-superpowers/` | Pinned 172-file source and 14-skill doctree. `brainstorming` reviewed B- with moderate confidence against real-agent issues, commits, tests, and maintainer evidence; remaining 13 skills are intentionally ungraded pending one-at-a-time review. |
