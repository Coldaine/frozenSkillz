...
| `REQ-011` | `DR-019` | `IF-06`, `IF-08` | `AC-CLIENT-006` | `FI-GAP-009` | `GAP-011`; `VQ-11` | `PHASE-1-DECISIONS`, `PHASE-2-CONTRACTS`, `PHASE-3-LOCAL-CORE`, `PHASE-4-CLIENT-RUNTIME`; `BL-004` |
| `REQ-012` | `DR-025`, `DR-026`, `DR-027` | `IF-05`, `IF-08`, `IF-09`, `IF-12` | `AC-PLAT-002`, `AC-INV-005`, `AC-RUN-002`, `AC-RUN-003`, `AC-RUN-004`, `AC-RUN-005`, `AC-EFF-004` | `FI-REQ-008`, `FI-GAP-014`, `FI-GAP-015` | `DEC-GAP-006`, `GAP-003`, `GAP-011`, `GAP-015`; `VQ-06` | `PHASE-1-DECISIONS`, `PHASE-2-CONTRACTS`, `PHASE-4-CLIENT-RUNTIME`, `PHASE-5-CONFORMANCE`; `BL-006`, `BL-007` |
