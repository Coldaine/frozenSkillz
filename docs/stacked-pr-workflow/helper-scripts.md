# Stacked PR Helper Scripts

This document explains the helper scripts that support the stacked PR workflow.
...
- [stack-preflight.ps1](../../plugins/frozen-skills/skills/stacked-pr-workflow/scripts/stack-preflight.ps1)
...
- [stack-inventory.ps1](../../plugins/frozen-skills/skills/stacked-pr-workflow/scripts/stack-inventory.ps1)
...
- [route-stack-scenario.ps1](../../plugins/frozen-skills/skills/stacked-pr-workflow/scripts/route-stack-scenario.ps1)
...
- [pr-base-audit.ps1](../../plugins/frozen-skills/skills/stacked-pr-workflow/scripts/pr-base-audit.ps1)
...
- [infer-pr-dependencies.ps1](../../plugins/frozen-skills/skills/stacked-pr-workflow/scripts/infer-pr-dependencies.ps1)
...
- [verify-parent-diffs.ps1](../../plugins/frozen-skills/skills/stacked-pr-workflow/scripts/verify-parent-diffs.ps1)
...
### `submit-with-graphite.ps1`

Path:

- [submit-with-graphite.ps1](../../plugins/frozen-skills/skills/stacked-pr-workflow/scripts/submit-with-graphite.ps1)
